...
In Guflow example example you can handle is much simple way as shown in this example. Unlike StepFunctions you do not need a seperate lambda functions to maintain the count.
